...
__C.root_path = '/home/sid/work/medical/'
__C.data_type = 'wrist'
data_path = __C.root_path + __C.data_type
...
if __C.mode == 'trans' or __C.mode == 'rpn_trans':
  __C.TRAIN.BATCH_SIZE = 128
...
__C.PIXEL_MEANS = np.array([[[127, 127, 127]]])
...
# Data directory
__C.DATA_DIR = osp.abspath(osp.join(__C.ROOT_DIR, data_path))
...
if __C.mode == 'trans' or __C.mode == 'rpn_trans':
  ...
  __C.FEAT_STRIDE = [8, ]
  # Anchor scales for RPN_FPN
  __C.FPN_ANCHOR_SCALES = [16, 32, 64, 128, 256]
  # Feature stride for RPN_FPN
  __C.FPN_FEAT_STRIDES = [2, 4, 8, 16, 32]
